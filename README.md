...
```sh
[ESP]
En este proyecto se desarrolla en 4 lenguajes (Python, Java, JS y PHP) la estructura de una Aplicacion Uber, utilizando los conceptos de 
Clases, Objetos, Subclases, Metodos, Polimorfismo y Herencia para definir las propiedades y el comportamiento de cada Automóvil,
representando a lo ultimo este proceso por medio de un diagrama UML.
```
